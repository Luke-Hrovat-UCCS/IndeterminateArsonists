...
if (shoot&& !obj_baby.carried)
{
	...
	{
		instance_create_layer(x, y, "BulletsLayer", obj_drone);
		ammo -= (150 +obj_controller._droneCost);
		cooldown_shoot = 20;
	}
