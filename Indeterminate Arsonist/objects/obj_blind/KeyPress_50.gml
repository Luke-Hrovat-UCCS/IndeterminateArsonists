...
switch(l25ECD1D3_0)
{
	...
	case rm_menu:
		...
		/// @DnDHash : 414359C9
		/// @DnDParent : 2B598903
		/// @DnDArgument : "room" "rm_store"
		/// @DnDSaveInfo : "room" "rm_store"
		room_goto(rm_store);
		break;
	...
	case rm_store:
		...
		else
		{
			...
			/// @DnDHash : 33851ADE
			/// @DnDParent : 1BCF603A
			/// @DnDArgument : "soundid" "sfx_fail"
			/// @DnDSaveInfo : "soundid" "sfx_fail"
			audio_play_sound(sfx_fail, 0, 0, 1.0, undefined, 1.0);
		}
		break;
	...
	case rm_gamemode:
		...
		/// @DnDHash : 08901931
		/// @DnDParent : 10F01FEA
		/// @DnDArgument : "room" "rm_level4"
		/// @DnDSaveInfo : "room" "rm_level4"
		room_goto(rm_level4);
		break;
